        ...
        <table>
            ...
            <tr>
                <td class="cells"><h3><?= $pull_adidas["name"] ?></h3>
                    <p> Prix: <?= formatPrice($pull_adidas["price"]) ?> Discount: <?= "${pull_adidas["discount"]}%" ?></p>
        ...
        <table>
            ...
            <tr>
                <td class="cells"><h3><?= $pull_champion["name"] ?></h3>
                    <p> Prix: <?= formatPrice($pull_champion["price"]) ?> Discount: <?= "${pull_champion["discount"]}%" ?></p>
        ...
        <table>
            ...
            <tr>
                <td class="cells"><h3><?= $pull_nike["name"] ?></h3>
                    <p> Prix: <?= formatPrice($pull_nike["price"]) ?> Discount: <?= "${pull_nike["discount"]}%" ?></p>
